...
int acc_example_service(int argc, char *argv[])
{
	...
	// Create sensor config (default config) "See Page 22 of A121 Sparse IQ Service User Guide"
	...
	// Allocate buffer (return the starting address of buffer)
	...
	// Create a sensor instance
	// A sensor instance represents a physical radar sensor 
	// and handles the communication with it.
	...
	// Calibrate sensor and prepare sensor for measurement
