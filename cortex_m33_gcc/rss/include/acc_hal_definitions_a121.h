 ...
 */
 // Type for a function pointer: points to a function that takes size_t
 // and returns void* (a generic address) like malloc
 // Here: just defining the type. No function, no variable, nothing in memory yet.
 // when see (*name)() it must be assigned to a function address
 ...
 */
 // this defines a type called acc_hal_mem_free_function_t,
 // this type will store the address of a function that 
 // needs to take a generic address as input and return nothing
