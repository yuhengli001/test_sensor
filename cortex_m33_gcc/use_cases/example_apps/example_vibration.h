...
#define ACC_VIBRATION_MAX_REPORTED_PEAKS 30U
...
typedef enum
{
	/** Preset for high frequency measurements */
	ACC_VIBRATION_PRESET_HIGH_FREQUENCY,
	/** Preset for low frequency measurements */
...
typedef struct
{
	...
	float   peak_displacements[ACC_VIBRATION_MAX_REPORTED_PEAKS];
	float   peak_frequencies[ACC_VIBRATION_MAX_REPORTED_PEAKS];
	uint8_t peak_count;
