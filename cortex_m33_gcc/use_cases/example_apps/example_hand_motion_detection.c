                                                                    ...
                                                                    acc_sensor_id_t                       sensor_id)
{
	...
	if (status)
	{
		...
		handle->hand_motion_detection_presence_processor =
		    acc_detector_presence_processing_create(handle->hand_motion_detection_presence_processing_config,
		                                            handle->hand_motion_detection_sensor_config);
...
void hand_motion_detection_process(hand_motion_detection_handle_t *handle, void *buffer, hand_motion_detection_result_t *hand_motion_detection_result)
{
	...
	else // HAND_MOTION_DETECTION_APP_MODE_HAND_MOTION
	{
		...
		acc_detector_presence_processing_process(handle->hand_motion_detection_presence_processor,
		                                         buffer,
		                                         hand_motion_detection_result->proc_result.frame,
		                                         &presence_processing_result);
