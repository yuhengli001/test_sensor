// Copyright (c) Acconeer AB, 2021-2026
// All rights reserved
...
int acc_exploration_server_stm32(int argc, char *argv[]);
...
int acc_exploration_server_stm32(int argc, char *argv[])
{
	...
	while (HAL_GPIO_ReadPin(DEBUG_UART_RX_GPIO_Port, DEBUG_UART_RX_Pin) == GPIO_PIN_RESET)
	{
	...
	acc_exploration_server_stm32_init("stm32", exploration_server_command_buffer, sizeof(exploration_server_command_buffer));
